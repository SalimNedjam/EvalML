...
from application.Api.GroupApi import AddUserToGroup, FetchUsersNotInGroup, LeaveGroup, ListGroupsChallenge, \
    RetrieveGroupList, RemoveUserGroup, AddUserGroupForStaff
...
urlpatterns = [
    ...
    url(r'api/group/leave_group/(?P<challenge>\d+)/$', LeaveGroup.as_view()),
