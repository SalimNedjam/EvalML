...
import {updateChallenge} from "../../../actions/application";
...
export class EditChallenge extends Component {
    ...
    onSubmit = e => {
        ...
        if (course === -1)
            ...
            this.props.updateChallenge(editedChallenge)
        }
    ...
    componentDidMount() {
        ...
        let challenge = this.props.listChallenge.find(item => item.challenge_id == match.params.challenge);
    ...
    render() {
        if (this.props.listChallenge != undefined && this.state.challenge == undefined)
        ...
        return (
            <div className="col-md-6 m-auto">
                <div className="card card-body mt-5">
                    <h2 className="text-center">{"Challenge edit"} </h2>
...
export default connect(mapStateToProps, {updateChallenge, createMessage})(EditChallenge);
