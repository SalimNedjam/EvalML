...
import {fetchSubmissionStaff, removeSubmission} from "../../../actions/application";
...
export class TableSubmission extends Component {
    ...
    componentDidMount() {
        this.props.fetchSubmissionStaff({challenge: this.props.challenge, user: this.props.user})
    }
...
export default connect(
    mapStateToProps,
    {fetchSubmissionStaff, removeSubmission}
)(TableSubmission);
